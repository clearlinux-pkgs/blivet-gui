...
Source0  : https://github.com/storaged-project/blivet-gui/releases/download/2.4.0-1/blivet-gui-2.4.0.tar.gz
...
%prep
%setup -q -n blivet-gui-2.4.0
cd %{_builddir}/blivet-gui-2.4.0
pushd ..
cp -a blivet-gui-2.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663605434
...
cp %{_builddir}/blivet-gui-2.4.0/COPYING %{buildroot}/usr/share/package-licenses/blivet-gui/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/blivet-gui-2.4.0/translation-canary/COPYING %{buildroot}/usr/share/package-licenses/blivet-gui/01a6b4bf79aca9b556822601186afab86e8c4fbf
