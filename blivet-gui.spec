...
Version  : 2.2.1.1
Release  : 6
URL      : https://github.com/storaged-project/blivet-gui/releases/download/2.2.1-1/blivet-gui-2.2.1.tar.gz
Source0  : https://github.com/storaged-project/blivet-gui/releases/download/2.2.1-1/blivet-gui-2.2.1.tar.gz
...
%prep
%setup -q -n blivet-gui-2.2.1
cd %{_builddir}/blivet-gui-2.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611355039
...
cp %{_builddir}/blivet-gui-2.2.1/COPYING %{buildroot}/usr/share/package-licenses/blivet-gui/4cc77b90af91e615a64ae04893fdffa7939db84c
