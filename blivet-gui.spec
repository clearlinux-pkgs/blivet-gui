...
Source0  : https://github.com/storaged-project/blivet-gui/releases/download/2.6.0/blivet-gui-2.6.0.tar.gz
...
%prep
%setup -q -n blivet-gui-2.6.0
cd %{_builddir}/blivet-gui-2.6.0
pushd ..
cp -a blivet-gui-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731941622
